            ...
            <div class="form-group">
                <el-form :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left" label-width="0px">
                    ...
                    <el-form-item prop="captcha" v-if="captcha.show" class="captcha">
                        <img :src="captcha.src" alt="" @click="_getCode">
                        <el-input v-model="loginForm.captcha" type="text" :placeholder="$t('global.captcha')" @keyup.enter.native="enterToLogin"></el-input>
                    </el-form-item>
                  ...
                  this.login({
                      ...
                      if(res.errcode==0){
                        this.$router.push('components/home')
                          ...
                          this._getCode()//再获取一遍验证码
                          for(var key in res.error){
                            this.loginForm[key]=''
                            this.loginRules[key][0].message=res.error[key]
                          }
